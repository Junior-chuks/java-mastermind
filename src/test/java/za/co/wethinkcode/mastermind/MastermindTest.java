...
class MastermindTest{
    ...
    @Test
    void testCheckNumbersReturn(){
        Mastermind returnValue = new Mastermind();
        String code = "2345";
        String guess = "2432";
        int counting = 12;
        int[] value = returnValue.checkNumber(code,guess,counting);

        assertEquals("[1, 3, 11]", Arrays.toString(value));
    }
